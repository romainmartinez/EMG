...
% Description : Traitement des fichiers de lever de caisse : RMS                 %
% Input : Matrice col_assign ; Matrice MVC ; Fichiers XP (c3d)                   % 
% Output : Matrice contenant les RMS de chaque essai                             %                                      
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
						  clc; clear; close all
